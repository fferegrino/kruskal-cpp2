...
{
	return {
		"name":			"kruskal-cpp2",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"kcpp2",				// this is used to identify this plugin and is saved to the project; never change it
